...
2. **永続ドキュメントの確認**
   ...
   - `~/Desktop/home-smart-factory-base/docs/basic-design/インフラ定義書.md`
   - `~/Desktop/home-smart-factory-base/docs/basic-design/システム構成図.md`
...
**3-4. 実装を実行**
```
開発ガイドライン（.claude/skills/development-guideline-java/guides/implementation-guide.md）に従って実装
```
